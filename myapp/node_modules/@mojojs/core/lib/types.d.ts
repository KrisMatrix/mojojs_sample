...
export declare type MojoRoute = Route;
...
export declare type TagAttrs = Record<string, string>;
...
export declare type ServerResponseBody = string | Buffer | Stream | undefined;
...
export declare type URLTarget = string | [string, URLOptions];
...
export declare type ValidatorFunction = (data: any) => ValidatorResult;

...
declare type ViewIndex = Record<string, ViewSuggestion[]>;
...
export declare class Renderer {
     ...
     */
    render(ctx: MojoContext, options: RenderOptions): Promise<EngineResult | null>;
    /**
     ...
     */
    warmup(): Promise<void>;
    _renderInline(ctx: MojoContext, options: RenderOptions): Promise<EngineResult | null>;
    _renderView(ctx: MojoContext, options: RenderOptions): Promise<EngineResult | null>;
}
export {};

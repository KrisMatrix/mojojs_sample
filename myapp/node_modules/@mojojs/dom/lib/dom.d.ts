...
declare type FormValue = string | string[] | null | FormValue[];
/**
...
export default class DOM {
     ...
     */
    static newTag(name: string, attrs?: Record<string, string | Record<string, string>> | string | SafeString, content?: string | SafeString): DOM;
    /**

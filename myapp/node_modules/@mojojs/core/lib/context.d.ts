...
import type { MojoAction, MojoModels, RenderOptions, URLOptions, ValidatorFunction } from './types.js';
...
declare type WebSocketHandler = (ws: WebSocket) => void | Promise<void>;
...
declare class Context extends EventEmitter {
     ...
     */
    redirectTo(target: string, options?: URLOptions & {
        status?: number;
    }): Promise<void>;
    /**
     ...
     */
    render(options?: RenderOptions, stash?: Record<string, any>): Promise<boolean>;
    /**
     * Try to render dynamic content to string.
     */
    renderToString(options: RenderOptions, stash?: Record<string, any>): Promise<string | null>;
    /**
     * Automatically select best possible representation for resource.
     */
    respondTo(spec: Record<string, MojoAction | RenderOptions>): Promise<void>;
    /**
     * Send static file.
     */
